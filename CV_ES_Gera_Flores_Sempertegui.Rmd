...
english_bullets <- c(
  ...
  "Standardized and optimized operational processes at Falabella, Tottus, Sodimac, and Linio, improving operational efficiency by 20\\%.",
  ...
  "Developed analytical solutions using SQL, R, Python, and Google Cloud, reducing operational times and errors by up to 50\\%.",
...
english_project_bullets <- c(
  ...
  "Increased purchase frequency by 20\\%, ticket size by 10\\%, and established significant commercial partnerships with suppliers."
