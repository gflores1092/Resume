...
#profilepic: "foto.png"
position: |
  | \scriptsize INDUSTRIAL ENGINEER MBA | MANAGEMENT | OPERATIONS | DATA & ANALYTICS | E-COMMERCE
#address: |
...
calendar <- function(text) {
  paste0("\\hfill\\scriptsize\\faCalendarCheckO\\hspace{0.05cm}", "{", text, "}")
}
...
spanish_bullets <- c(
  ...
  #[1]
  "Lideré un equipo técnico a cargo de la gestión de proyectos regionales a nivel LATAM para Mondelez International.",
  "a.",
  "b.",
  "c.",
  "d",
  ...
  #[6]
  paste0("\\textbf{Experiencia adicional:} Más de 5 años de experiencia como docente y consultora independiente y en áreas de experiencia del cliente, comercial, finanzas, logística y producción en empresas como Entel, Goodyear, FLSmidth y Metso. Mayor detalle en ", 
