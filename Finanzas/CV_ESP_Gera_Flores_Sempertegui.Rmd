...
spanish_summary <- c(
  "Líder ejecutiva con más de 10 años de trayectoria en e-commerce, tecnología y startups. Experta en gestión y comercial con sólidas habilidades técnicas. Preparada para roles de alta dirección, capaz de liderar equipos grandes y comprometida con la innovación y el crecimiento en entornos dinámicos. Reconocida por ser una profesional data driven con proyectos e iniciativas de alto impacto."
)
...
spanish_titles <- c(
  "\\textbf{Head of Operations} | FALABELLA.COM | Lima, Perú | 2021 -",
  "\\textbf{Logistics Performance Manager} | PEDIDOSYA | Lima, Perú | 2021",
  "\\textbf{Growth Marketing Lead} | GLOVO | Lima, Perú | 2020 - 2021",
  "\\textbf{Analytics Lead} | GLOVO | Lima, Perú | 2018 - 2019",
  "\\textbf{Consultora de negocios} | INDEPENDIENTE | Lima, Perú | 2017 -",
  "\\textbf{Docente} | INDEPENDIENTE | Lima, Perú | 2017 -"
)
...
spanish_bullets <- c(
  ...
  #[7]
  "\\textbf{Experiencia adicional:} Más de 5 años de experiencia en áreas de experiencia del cliente, comercial, logística y producción en empresas como Entel, Goodyear, FLSmidth y Metso. Mayor detalle en LinkedIn."
...
spanish_degrees <- tribble(
  ~degree,
  "\\textbf{Maestría en Administración de Negocios} | CENTRUM - PONTIFICIA UNIVERSIDAD CATÓLICA DEL PERÚ | Lima, Perú | 2018",
  "\\textbf{Administración de Negocios Globales} | MAASTRICHT UNIVERSITY | Maastricht, Países Bajos | 2018",
  "\\textbf{Administración de Negocios Globales} | UNIVERSITY OF VICTORIA | Victoria, British Columbia, Canadá | 2018",
  "\\textbf{Ingeniería Industrial} | PONTIFICIA UNIVERSIDAD CATÓLICA DEL PERÚ | Lima, Perú | 2014"
)
...
english_certifs <- tribble(~degree,
  ...
  "\\textbf{Data Management and Analytics} | CENTRUM Pontificia Universidad Católica del Perú | 2016"
)
...
tribble(~degree,
        paste0("\\small{", degrees$degree[1], "}\\hfill"),
        paste0("\\small{", degrees$degree[2], "}\\hfill"),
        paste0("\\small{", degrees$degree[3], "}\\hfill"),
        paste0("\\small{", degrees$degree[4], "}\\hfill"),
        "\\tiny"
        ) %>%
        tabular()
```
...
tribble(~degree,
        paste0("\\small{", certifs$degree[1], "}\\hfill"),
        paste0("\\small{", certifs$degree[2], "}\\hfill"),
        paste0("\\small{", certifs$degree[3], "}\\hfill"),
        paste0("\\small{", certifs$degree[4], "}\\hfill"),
        "\\tiny"
        ) %>%
        tabular()
```
