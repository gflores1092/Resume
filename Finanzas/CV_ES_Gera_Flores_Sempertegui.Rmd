...
spanish_bullets <- c(
  ...
  "Lideré el proceso de collections, implementé procesos contables y gestioné reportes financieros internos y externos.",
  "Diseñé, ejecuté y automaticé la estrategia de recuperación de cuentas por cobrar recuperando hasta S/. 8 millones.",
  "Desarrollé y ejecuté presupuestos, hice seguimiento de transacciones contables y optimización de costos operativos.",
  "Realicé reportes financieros detallados para la gerencia general, siendo responsable de la comunicación y gestión.",
  ...
  "Planeé y ejecuté presupuestos operativos, optimicé costos, coordiné el proceso de cobro y supervisé flujo de efectivo.",
  "Implementé procedimientos financieros para la gestión de gastos y lideré la estrategia de cobros.",
  ...
  "Desarrollé y gestioné presupuestos de marketing, optimizando el flujo de efectivo y los costos de las campañas.",
  ...
  "Apoyé en la construcción y ejecución de modelos financieros para nuevos negocios junto con proyecciones financieras.",
  "Supervisé la creación de reportes financieros detallados por concepto contable para apoyar la planificación estratégica."
